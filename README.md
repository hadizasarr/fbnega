Goal: use 3-year dataset to illustrate county- and partner-level distribution; flag shifts by county/product/partner and designed a data-driven resource allocation engine
...
*** To run code: clone repository & python3 [name of script] in src *** 

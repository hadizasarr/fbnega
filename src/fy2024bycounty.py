...
def fy2024_by_county():
    """
    Reads 'FY 2024 by County Totals.csv' and writes separate per-county CSV files.
    Prints a row count summary to confirm integrity.
    """
    file_path = "../data/data csv/FY 2024 by County Totals.csv"
    output_dir = "../data/FY 2024 Split by County"
    ...
    for county in df["County"].unique():
        ...
        output_path = os.path.join(output_dir, f"{safe_name}_FY2024.csv")

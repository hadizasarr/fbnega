...
def fh2025_by_county():
    """
    Reads 'FH 2025 by County Totals.csv' and writes separate per-county CSV files.
    Prints a row count summary to confirm integrity.
    """
    file_path = "../data/data csv/FH 2025 by County Totals.csv"
    output_dir = "../data/FH 2025 Split by County"
    ...
    for county in df["County"].unique():
        ...
        output_path = os.path.join(output_dir, f"{safe_name}_FH2025.csv")

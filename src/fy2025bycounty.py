...
def fy2025_by_county():
    """
    Reads 'FY 2025 by County Totals.csv' and writes separate per-county CSV files.
    Prints a row count summary to confirm integrity.
    """
    file_path = "../data/data csv/FY 2025 by County Totals.csv"
    output_dir = "../data/FY 2025 Split by County"
    ...
    for county in df["County"].unique():
        ...
        output_path = os.path.join(output_dir, f"{safe_name}_FY2025.csv")
